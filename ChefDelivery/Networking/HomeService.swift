...
//  ChefDelivery
//
//  Created by Erica Rodrigues on 13/02/25.
//
...
struct HomeService {
    func fetchData() async throws -> Result<[StoreType], RequestError> {
        guard let url = URL(string: "https://private-8d033b-ericarodrigues.apiary-mock.com/home") else {
    ...
    func fetchDataWithAlamofire(completion: @escaping ([StoreType]?, Error?) -> Void) {
        AF.request("https://private-8d033b-ericarodrigues.apiary-mock.com/home").responseDecodable(of: [StoreType].self) { response in
